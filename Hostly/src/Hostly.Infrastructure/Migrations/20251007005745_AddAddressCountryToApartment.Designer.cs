...
namespace Hostly.Infrastructure.Migrations
{
    ...
    [Migration("20251007005745_AddAddressCountryToApartment")]
    partial class AddAddressCountryToApartment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hostly.Domain.Apartments.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Hostly.Domain.Bookings.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Hostly.Domain.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Hostly.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Hostly.Domain.Apartments.Apartment", b =>
                {
                    b.OwnsOne("Hostly.Domain.Apartments.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("Hostly.Domain.Shared.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Hostly.Domain.Shared.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Hostly.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("Hostly.Domain.Apartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
                    ...
                    b.HasOne("Hostly.Domain.Users.User", null)
                        .WithMany()
                    ...
                    b.OwnsOne("Hostly.Domain.Shared.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("Hostly.Domain.Shared.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Hostly.Domain.Shared.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Hostly.Domain.Bookings.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Hostly.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("Hostly.Domain.Bookings.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
